...
public class SignupFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        etBusId = v.findViewById(R.id.bus_id_et);
        etBusRoute = v.findViewById(R.id.bus_route_et);
...
//        etPhoneNumber.setHint(listener.placeholder());
    ...
    private void initListener() {
        ...
        btnSendCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (etBusId.getText().toString().equals("")) {
                    Toast.makeText(getActivity(), "Please enter your Bus ID!", Toast.LENGTH_LONG).show();
                    return;
                }

                if (etBusId.getText().toString().equals("")) {
                    Toast.makeText(getActivity(), "Please enter your Bus Route", Toast.LENGTH_LONG).show();
                    return;
                }

                busId = etBusId.getText().toString();
                busRoute = etBusRoute.getText().toString();
    ...
    private void signupWithUserInfo() {
        ...
        signupInfo.bus_ID = busId;
        signupInfo.password = password;
        signupInfo.busRoute = busRoute;
        signupInfo.created_Date = "";

        Call<LoginResponse> call = apiInterface.singupWithUserInfo(phonenumber, signupInfo);
