...
import muflar.com.muflar.fragment.LoginFragment;
...
//                successAnimationPart();
    ...
    private void loginWithCardno(){

        final EditText etCardNo = (EditText) frag_login.getView().findViewById(R.id.et_cardno);
        ...
        Call<User> call = apiInterface.loginWithCardno(cardno, password);
                ...
                .setListener(new Animator.AnimatorListener(){
                    ...
                    public void onAnimationEnd(Animator p1) {
                        ...
                        switch(errorCode) {
                            ...
                            case 500: {
                                Toast.makeText(StartActivity.this, "Your Card number or Password is not correct!", Toast.LENGTH_LONG).show();
                                return;
                            }
                            default:
                                return;
